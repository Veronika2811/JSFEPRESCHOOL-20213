export const ICON_CORY_CARD =
  '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" fill="none"><rect x="2.46826" y="0.25" width="10.5917" height="9.5" rx="0.75" stroke="black" stroke-width="0.5"/><rect x="0.25" y="2.25" width="10.5917" height="9.5" rx="0.75" fill="white" stroke="black" stroke-width="0.5"/></svg>';
export const ICON_VISITS =
...
export const ICON_BOOKS =
  '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none"><rect width="20" height="21" fill="#BB945F"></rect><rect x="2" width="1" height="19" fill="#826844"></rect><rect x="1" width="1" height="21" fill="white"></rect></svg>';

export const LIBRARY_FORM_BUTTONS = {
  auth: ['Profile'],
  noAuth: ['Sign Up', 'Log in'],
};
...
export const USER_INFO = [
  {title: 'visits', svg: ICON_VISITS},
  {title: 'bonuses', svg: ICON_BONUSES},
  {title: 'books', svg: ICON_BOOKS},
];
